...
REAL (C_DOUBLE ), DIMENSION(-1:102, -1:52, 1:4), INTENT(IN) :: state_init
REAL (C_DOUBLE ), DIMENSION(1:100, 1:50, 1:4), INTENT(INOUT) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), INTENT(IN) :: dt
REAL (C_DOUBLE ), DIMENSION(-1:102, -1:52, 1:4), INTENT(OUT) :: state_out
...
REAL (C_DOUBLE ), DIMENSION(-1:102, -1:52, 1:4), INTENT(INOUT) :: state
REAL (C_DOUBLE ), DIMENSION(-1:52), INTENT(IN) :: hy_dens_cell
