...
export COMM, NRANKS, MYRANK, SIM_TIME, NX_GLOB, NZ_GLOB, OUT_FREQ, LOG_FREQ, DATA_SPEC
export OUTFILE, WORKDIR, DEBUGDIR, NPER, I_BEG, I_END, NX, NZ, LEFT_RANK, RIGHT_RANK
export K_BEG, MASTERRANK, MASTERPROC, HS, STEN_SIZE, NUM_VARS, XLEN, ZLEN, HV_BETA
export CFL, MAX_SPEED, DX, DZ, DT, NQPOINTS, PI, GRAV, CP, CV, RD, P0, C0, GAMMA
export ID_DENS, ID_UMOM, ID_WMOM, ID_RHOT, DIR_X, DIR_Z, DATA_SPEC_COLLISION
export DATA_SPEC_THERMAL, DATA_SPEC_GRAVITY_WAVES, DATA_SPEC_DENSITY_CURRENT
export FLOAT, INTEGER, DATA_SPEC_INJECTION, qpoints, qweights
